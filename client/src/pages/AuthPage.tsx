			...
			<div className="flex flex-col rounded-[1rem] overflow-hidden max-w-[55rem] w-full fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] shadow-[rgba(100,100,111,0.1)_0_0.7rem_2.9rem_0]">
				...
				<div className="flex flex-col p-[4.4rem_3.2rem_3.2rem]">
					<div className={index === 0 ? "visible" : "hidden"}>
						<form name="form-auth" className="flex flex-col gap-6">
							...
							<button className="flex items-center justify-center mt-[3.2rem] h-[3.6rem] bg-[#e4e4e4] rounded-[0.25rem] hover:text-[#fff] hover:bg-green-500 transition-all px-20 mx-auto max-w-[24.3rem] w-full" type="button">Войти</button>
						</form>
					</div>
					<div className={index === 1 ? "visible" : "hidden"}>
						<form name="form-reg" className="flex flex-col gap-6">
							<label className="flex flex-col gap-[0.6rem]">
								Почта:
								<input
									className="inline-flex w-full h-[3.6rem] text-[1.4rem] px-5 outline-none border-b border-b-[#e4e4e4] transition-all focus:placeholder:opacity-0 placeholder:transition-all focus:border-b-[#222]"
							...
							<button className="flex items-center justify-center mt-[3.2rem] h-[3.6rem] bg-[#e4e4e4] rounded-[0.25rem] hover:text-[#fff] hover:bg-green-500 transition-all px-20 mx-auto max-w-[24.3rem] w-full" type="button">Зарегистрироваться</button>
						</form>
					</div>
				</div>
			</div>
